...
/* ---------------------------------------------------------
   CoyToy — Landing Page
   Matches cyberpunk aesthetic from the main shop (Home.jsx)
--------------------------------------------------------- */
...
@media (prefers-reduced-motion: reduce) {
  .ct-hero-title, .ct-hero-sub, .ct-cta-primary, .ct-cta-secondary,
  .ct-card, .ct-ticker-track, .ct-offer-badge {
    animation: none !important;
  }
  .ct-scanline { display: none !important; }
}
...
@media (max-width: 720px) {
  ...
  .ct-cta-primary, .ct-cta-secondary {
    width: 100%;
