...
/* ---------------------------------------------------------
   CoyToy — Forgot Password
   Shares tokens + injected styles with Login/Signup (same
   STYLE_ID guard, so whichever page mounts first injects the CSS once).
--------------------------------------------------------- */
...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // auth/user-not-found is deliberately shown as success too, so this
      ...
      >
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              type="submit"
              className="coytoy-cauth-submit-btn"
              disabled={submitting}
            >
        ...
        >
          <Link to="/login" className="coytoy-cauth-switch-link">
            Back to Log In
          </Link>
        </p>
      </div>
